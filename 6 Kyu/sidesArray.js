...
// Your function will return the index 1, because at the 
// 1st position of the array, the sum of left side of the index ({1}) 
...
function findEvenIndex(arr){
	// get total and then decrease it by i until you reach equilibrium
  var rightSide = arr.reduce(function(a,b){
  	return a+b;
  },0);
  var leftSide = 0;
